...
namespace Clinic.API.Migrations
{
    ...
    [Migration("20191217054858_EditPrescriptionAndReferralModel")]
    partial class EditPrescriptionAndReferralModel
    {
            ...
            modelBuilder.Entity("Clinic.API.Models.Contract", b =>
                {
                    ...
                    b.HasOne("Clinic.API.Models.MedArea", null)
                        .WithMany("Contracts")
            ...
            modelBuilder.Entity("Clinic.API.Models.Prescription", b =>
                {
                    ...
                    b.HasOne("Clinic.API.Models.Drug", null)
                        .WithMany("Prescriptions")
            ...
            modelBuilder.Entity("Clinic.API.Models.Referral", b =>
                {
                    ...
                    b.HasOne("Clinic.API.Models.Treatment", null)
                        .WithMany("Referrals")
